...
[![Build Status](https://travis-ci.org/Gitforxuyang/protoreflect.svg?branch=master)](https://travis-ci.org/Gitforxuyang/protoreflect/branches)
[![Go Report Card](https://goreportcard.com/badge/github.com/Gitforxuyang/protoreflect)](https://goreportcard.com/report/github.com/Gitforxuyang/protoreflect)
...
[![GoDoc](https://godoc.org/github.com/Gitforxuyang/protoreflect?status.svg)](https://godoc.org/github.com/Gitforxuyang/protoreflect)

----
## Descriptors: The Language Model of Protocol Buffers

```go
import "github.com/Gitforxuyang/protoreflect/desc"
```
...
*[Read more ≫](https://godoc.org/github.com/Gitforxuyang/protoreflect/desc)*

```go
import "github.com/Gitforxuyang/protoreflect/desc/protoparse"
```
...
*[Read more ≫](https://godoc.org/github.com/Gitforxuyang/protoreflect/desc/protoparse)*

```go
import "github.com/Gitforxuyang/protoreflect/desc/protoprint"
```
...
*[Read more ≫](https://godoc.org/github.com/Gitforxuyang/protoreflect/desc/protoprint)*

```go
import "github.com/Gitforxuyang/protoreflect/desc/builder"
```
...
*[Read more ≫](https://godoc.org/github.com/Gitforxuyang/protoreflect/desc/builder)*

----
## Dynamic Messages and Stubs

```go
import "github.com/Gitforxuyang/protoreflect/dynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/Gitforxuyang/protoreflect/dynamic)*

```go
import "github.com/Gitforxuyang/protoreflect/dynamic/grpcdynamic"
```
...
*[Read more ≫](https://godoc.org/github.com/Gitforxuyang/protoreflect/dynamic/grpcdynamic)*

----
## gRPC Server Reflection

```go
import "github.com/Gitforxuyang/protoreflect/grpcreflect"
```
...
*[Read more ≫](https://godoc.org/github.com/Gitforxuyang/protoreflect/grpcreflect)*
